		...
		r.Get("/debug/env", func(w http.ResponseWriter, r *http.Request) {
			...
			resp := map[string]any{
				"config": map[string]any{
					...
					"replicator_database_url": sanitizeDatabaseURL(cfg.ReplicatorDatabaseURL),
				},
				"env": map[string]any{
					"DATABASE_URL":             sanitizeDatabaseURL(getEnvOrEmpty("DATABASE_URL")),
					"REPLICATOR_DATABASE_URL":  sanitizeDatabaseURL(getEnvOrEmpty("REPLICATOR_DATABASE_URL")),
